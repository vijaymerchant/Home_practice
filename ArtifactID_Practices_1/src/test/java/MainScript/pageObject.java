...
public class pageObject {
	...
	@FindBy(xpath = ".//*[@id='content']/ul/li[1]/a") // (linkText = "A/B
														// Testing")
	...
	public void AB_Testing_click() {

		// System.out.println(driver);
		AB_Testing.click();
	}

	public void BasicAuth_click() {
		BasicAuth.click();
	}

	public void BrokenImages_click() {
		BrokenImages.click();
	}

	public void ChallengingDOM_click() {
		ChallengingDOM.click();
	}

	public void Checkboxes_click() {
		Checkboxes.click();
	}
	...
	public void DisappearingElements_click() {
		DisappearingElements.click();
	}

	public void DragandDrop_click() {
		DragandDrop.click();
	}
	...
	public void DynamicContent_click() {
		DynamicContent.click();
	}

	public void DynamicControls_click() {
		DynamicControls.click();
	}

	public void DynamicLoading_click() {
		DynamicLoading.click();
	}

	public void ExitIntent_click() {
		ExitIntent.click();
	}

	public void FileDownload_click() {
		FileDownload.click();
	}

	public void FileUpload_click() {
		FileUpload.click();
	}

	public void FloatingMenu_click() {
		FloatingMenu.click();
	}
	...
	public void FormAuthentication_click() {
		FormAuthentication.click();
	}

	public void Frames_click() {
		Frames.click();
	}

	public void Geolocation_click() {
		Geolocation.click();
	}

	public void HorizontalSlider_click() {
		HorizontalSlider.click();
	}

	public void Hovers_click() {
		Hovers.click();
	}

	public void InfiniteScroll_click() {
		InfiniteScroll.click();
	}

	public void JQueryUIMenus_click() {
		JQueryUIMenus.click();
	}

	public void JavaScriptAlerts_click() {
		JavaScriptAlerts.click();
	}

	public void JavaScriptonloadeventerror_click() {
		JavaScriptonloadeventerror.click();
	}

	public void KeyPresses_click() {
		KeyPresses.click();
	}

	public void LargeandDeepDOM_click() {
		LargeandDeepDOM.click();
	}

	public void MultipleWindows_click() {
		MultipleWindows.click();
	}

	public void NestedFrames_click() {
		NestedFrames.click();
	}

	public void NotificationMessages_click() {
		NotificationMessages.click();
	}

	public void RedirectLink_click() {
		RedirectLink.click();
	}

	public void SecureFileDownload_click() {
		SecureFileDownload.click();
	}

	public void ShiftingContent_click() {
		ShiftingContent.click();
	}

	public void SlowResources_click() {
		SlowResources.click();
	}

	public void SortableDataTables_click() {
		SortableDataTables.click();
	}

	public void StatusCodes_click() {
		StatusCodes.click();
	}

	public void Typos_click() {
		Typos.click();
	}

	public void WYSIWYGEditor_click() {
		WYSIWYGEditor.click();
	}
